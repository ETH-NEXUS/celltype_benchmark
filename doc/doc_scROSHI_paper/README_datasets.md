...
```
cellranger count --id=b_cells --transcriptome=refdata-cellranger-GRCh38-3.0.0 --localcores=24 --fastqs=b_cells_fastqs --nosecondary
```
...
Command to merge: 
`cellranger aggr --id=zheng_merged --csv=aggregate_libraries.csv --normalize=none`
...
`Rscript /PATH_TO_GIT/scripts/subset_data_proportional.R --input_data Zheng_merged.h5 --true_labels zheng_ground_truth.tsv --output_subset Zheng_subset.h5`
...
`python /PATH/TO/GIT/scripts/generate_ground-truth_list.py --original_labels zheng_original.tsv --label_dictionary matched_types_dictionary.tsv --output zheng_ground_truth.tsv --subtype_dictionary major_subtype_mapping.txt`
...
```
Rscript /PATH/TO/GIT/scripts/add_sce_groundtruth.R --sce_in Zheng_subset.RDS --sce_out Zheng_merged_annotated.RDS --labels_in zheng_ground_truth.tsv
```
----------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------
...
Subsetting was performed with an R script as follows (on the h5 file generated by the scAmpi pipeline):
`Rscript /PATH_TO_GIT/scripts/subset_data_proportional.R --input_data 2020-Mar-Census-Adult-Immune-10x.h5 --true_labels 2020-Mar-Census-Adult-Immune-10x.ground_truth.tsv --output_subset 2020-Mar-Census-Adult-Immune-10x.scp_subset.h5`
...
Command used to generate ground-truth dictionary for the Zheng data:
`python /PATH/TO/GIT/scripts/generate_ground-truth_list.py --original_labels 2020-Mar-Census-Adult-Immune-10x_annotated_v1.scp.metadata.txt --label_dictionary matched_types_dictionary.tsv --output 2020-Mar-Census-Adult-Immune-10x.ground_truth.tsv --subtype_dictionary major_subtype_mapping.txt`

Now the RDS file generated by scAmpi (containing the SCE object with count data) can be annotated  with the ground-truth labels (Zheng data):
```
Rscript /PATH/TO/GIT/scripts/add_sce_groundtruth.R --sce_in 2020-Mar-Census-Adult-Immune-10x_subset.RDS --sce_out 2020-Mar-Census-Adult-Immune-10x_subset_annotated.RDS --labels_in 2020-Mar-Census-Adult-Immune-10x.ground_truth.tsv
```
...
Subsetting was performed with an R script as follows (on the h5 file generated by the scAmpi pipeline):
`Rscript /PATH_TO_GIT/scripts/subset_data_proportional.R --input_data 2020-Mar-Newborn-Blood-10x.h5 --true_labels 2020-Mar-Census-Newborn-Blood-10x.ground_truth.tsv --output_subset 2020-Mar-Census-Newborn-Blood-10x.scp_subset.h5`
...
Command used to generate ground-truth dictionary for the Zheng data:
`python /PATH/TO/GIT/scripts/generate_ground-truth_list.py --original_labels 2020-Mar-Census-Newborn-Blood-10x_annotated_v1.scp.metadata.txt --label_dictionary matched_types_dictionary.tsv --output 2020-Mar-Census-Newborn-Blood-10x.ground_truth.tsv --subtype_dictionary major_subtype_mapping.txt`

Now the RDS file generated by scAmpi (containing the SCE object with count data) can be annotated  with the ground-truth labels (Zheng data):
```
Rscript /PATH/TO/GIT/scripts/add_sce_groundtruth.R --sce_in 2020-Mar-Census-Newborn-Blood-10x_subset.RDS --sce_out 2020-Mar-Census-Newborn-Blood-10x_subset_annotated.RDS --labels_in 2020-Mar-Census-Newborn-Blood-10x.ground_truth.tsv
```
