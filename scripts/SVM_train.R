...
data_svm <- bind_cols(lab_data,sce_data) %>%
  mutate(label=as.factor(label))
lev = levels(data_svm$label)

#cross validation
training_fold = data_svm[cvindex$train_data, ]
test_fold = data_svm[cvindex$test_data, ]
